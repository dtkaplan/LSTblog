...
Once you have gained experience creating WebR *quarto* documents, you will want to learn how to deploy them to a web server so that your students can use them, too. If there is interest, that can be the subject of another post. 
